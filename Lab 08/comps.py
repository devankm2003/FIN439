...
Standard-library Python script implementing comparable-company valuation.
Supports Microsoft Corporation (MSFT) with Alphabet (GOOGL) and Oracle (ORCL),
with the Asbury Automotive Group (ABG) training case preserved.
"""
...
# EDITABLE INPUTS
# ==============================================================================
# To switch between Microsoft (MSFT) and the Asbury training case, toggle comments.

# --- Company Case: Microsoft Corporation (NASDAQ: MSFT, Valuation Date: Sept 10, 2026) ---
TARGET = {
    "name": "Microsoft Corporation",
    "ticker": "MSFT",
    "price": 491.65,  # Closing price September 10, 2026 ($)
    "eps": 11.80,     # FY2024 total GAAP diluted EPS ($) [Form 10-K, Note 19 p. 98]
}
...
PEERS = [
    {
        "name": "Alphabet Inc.",
        "ticker": "GOOGL",
        "price": 330.39,  # Closing price September 10, 2026 ($)
        "eps": 8.04,      # FY2024 total GAAP diluted EPS ($) [Form 10-K, Note 11]
    },
    {
        "name": "Oracle Corporation",
        "ticker": "ORCL",
        "price": 152.94,  # Closing price September 10, 2026 ($)
        "eps": 4.34,      # FY2025 total GAAP diluted EPS ($) [Form 10-K, Note 13]
    },
]

# --- Training Case (uncomment below and comment above to reproduce Asbury training case) ---
# TARGET = {
